...
void DeInitWidget::palmWuran()
{
	...
	ui.label_29->setText(QString("β   %1\nα   %2").arg(pValue[0][0]).arg(pValue[0][1]));
	ui.label_32->setText(QString("β   %1\nα   %2").arg(pValue[1][0]).arg(pValue[1][1]));
	ui.label_36->setText(QString("β   %1\nα   %2").arg(pValue[2][0]).arg(pValue[2][1]));
	ui.label_37->setText(QString("β   %1\nα   %2").arg(pValue[3][0]).arg(pValue[3][1]));
